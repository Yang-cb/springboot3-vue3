...
public class SecurityConfiguration {
    ...
    /**
     * 配置允许的跨域请求路径
     * 不配置的错误信息：Access to XMLHttpRequest at '<a href="http://localhost:8080/api/auth/login">...</a>' from origin '<a href="http://localhost:5173">...</a>' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource.
     */
